    ...
    <main>
      <section>
        <div className="relative">
          ...
          <div className="relative py-20 lg:py-60 px-5 lg:px-10 max-w-screen-lg mx-auto">
            ...
            <a
              href="google.com"
              className="px-4 py-2 text-2xl uppercase bg-white text-blue-500 rounded-sm"
            >
              View Link
            </a>
          </div>
      ...
      <section className="bg-blue-500">
        <div className="flex items-center py-20 lg:py-40 px-5 lg:px-10 max-w-screen-lg mx-auto">
          <div className="w-1/2 px-5">
            <h2 className="pb-7 text-3xl font-light drop-shadow-md">
              Our product makes your life easier.
            </h2>
            <p>
              Lorem ipsum dolor sit amet, officia excepteur ex fugiat
              reprehenderit enim labore culpa sint ad nisi Lorem pariatur mollit
              ex esse exercitation ameSit irure elit esse ea nulla sunt ex
              occaecat reprehenderit commodo officia dolor Lorem duis laboris
              cupidat. Aliqua reprehenderit commodo ex non excepteur duis sunt
      ...
      <section>
        <div className="max-w-screen-md mx-auto">
          <ul className="flex justify-around py-20 text-center">
            ...
            <li>
              <span className="text-5xl">104</span>
              <p className="text-sm">Happy Customers</p>
            </li>
            <li>
              <span className="text-5xl">0</span>
              <p className="text-sm">Hassle</p>
            </li>
          </ul>
        </div>
      </section>
      ...
      <section className="bg-blue-500">
        <div className="py-20 lg:py-60 px-5 lg:px-10 max-w-screen-lg mx-auto">
          <h3 className="text-4xl lg:text-5xl font-light pb-7 drop-shadow-md">
            Featured Posts
          </h3>
          <div className="pb-7">
          ...
          <div className="flex justify-center">
            <Link
              href="/blog"
              className="px-4 py-2 text-xl uppercase bg-white text-blue-500 rounded-sm drop-shadow-lg"
            >
              View all posts
            </Link>
          </div>
      ...
      <section>
        <div className="py-20 lg:py-40 px-5 lg:px-10 text-center max-w-screen-lg mx-auto">
          <h4 className="pb-7 text-5xl font-light">
          ...
          <div className="flex justify-center">
            <Link
              href="/contact"
              className="px-4 py-2 text-xl uppercase bg-white text-blue-500 rounded-sm"
            >
              Contact Us
            </Link>
          </div>
